...
HD_PWD='C:/Users/isaac/ecen248/lab_11/lab_11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tlc_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tlc_controller.tcl -notrace
