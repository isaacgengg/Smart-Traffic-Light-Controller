...
HD_PWD='C:/Users/isaac/ecen248/lab_11/lab_11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tlc_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tlc_controller.tcl
