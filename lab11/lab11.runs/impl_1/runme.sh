...
HD_PWD='C:/Users/isaac/ecen248/lab11/lab11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tlc_controller_verl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tlc_controller_verl.tcl -notrace
